"""Green API provider client implementation."""
...
class GreenAPIClient(BaseClient):
    ...
    def send_text_message(
        ...
        **kwargs
        ...
        Args:
            ...
            text: Message text
            reply_to: Message ID to reply to (Green API: maps to quotedMessageId)
            mentions: List of phone numbers to mention (Green API: partial support)
            link_preview: Show link preview (Green API: direct support)
        
        TODO: Implement actual Green API call with translation:
              - chat_id -> chatId with @c.us suffix
              - text -> message
              - reply_to -> quotedMessageId
        """
        raise NotImplementedError(
            "Green API client implementation is in progress. "
    ...
    def send_image(
        ...
        **kwargs
        ...
        """Send an image message via Green API.
        
        TODO: Implement actual Green API call
        """
        raise NotImplementedError("Green API client implementation is in progress.")
    ...
    def send_file(
        ...
        **kwargs
        ...
        """Send a file message via Green API.
    ...
    def send_audio(
        ...
        **kwargs
        ...
        """Send an audio message via Green API.
    ...
    def send_video(
        ...
        **kwargs
        ...
        """Send a video message via Green API.
    ...
    def send_location(
        ...
        **kwargs
        ...
        """Send a location message via Green API.
    ...
    def get_chats(self, limit: Optional[int] = None, **kwargs) -> list[Chat]:
        """Get list of chats from Green API.
    ...
    def mark_as_read(
        ...
        **kwargs
        ...
        """Mark message as read via Green API.
    ...
    def get_contacts(self, **kwargs) -> list[Contact]:
        """Get contacts list from Green API.
    ...
    def check_number_status(self, phone_number: str, **kwargs) -> bool:
        """Check if number is on WhatsApp via Green API.
